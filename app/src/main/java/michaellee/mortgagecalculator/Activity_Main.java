            ...
            public void onClick(View v) {
                ...
                switch (currentItem) {
                    case 0:
                        ...
                        if (!TextUtils.isEmpty(CommMortgage) && Double.valueOf(CommMortgage) == 0) {
                    ...
                    case 1:
                        ...
                        if (!TextUtils.isEmpty(HAFMortgage) && Double.valueOf(HAFMortgage) == 0) {
                            builder.setMessage("贷款金额不能为0");
                            builder.setTitle("提示");
                            builder.setPositiveButton("好的", new DialogInterface.OnClickListener() {
                                @Override
                    ...
                    case 2:
                        ...
                        double sum = 0.0;
                        if (!TextUtils.isEmpty(CombMortgageHAF) && !TextUtils.isEmpty(CombMortgageComm)) {
                            sum = Double.valueOf(CombMortgageHAF) + Double.valueOf(CombMortgageComm);
                        }
    ...
    public void setRateTextView() {
        switch (currentItem) {
            case 0: {
                ...
                double originDouble = Double.valueOf(TextUtils.isEmpty(rateString) ? "0" : rateString);
                double discountDouble = Double.valueOf(TextUtils.isEmpty(discountString) ? "0" :discountString);
            ...
            case 2: {
                ...
                double originHAFDouble = Double.valueOf(TextUtils.isEmpty(rateHAFString) ? "0" :rateHAFString);
                double discountHAFDouble = Double.valueOf(TextUtils.isEmpty(discountHAFString) ? "0" :discountHAFString);
                double resultHAFDouble = originHAFDouble * discountHAFDouble;

                double originCommDouble = Double.valueOf(TextUtils.isEmpty(rateCommString) ? "0" :rateCommString);
                double discountCommDouble = Double.valueOf(TextUtils.isEmpty(discountCommString) ? "0" :discountCommString);
    ...
    public void setFistPay() {
        switch (currentItem) {
            case 0: {
                ...
                double priceDouble = Double.valueOf(TextUtils.isEmpty(priceString) ? "0" :priceString);
                double areaDouble = Double.valueOf(TextUtils.isEmpty(areaString) ? "0" :areaString);
                double sum = priceDouble * areaDouble / 10000;
                double percentDouble = Double.valueOf(TextUtils.isEmpty(percentString) ? "0" :percentString) / 10;
            ...
            case 2: {
                ...
                double percentDouble = Double.valueOf(TextUtils.isEmpty(percentString) ? "0" :percentString) / 10;                          //首付比例
                ...
                double HAFDouble = Double.valueOf(TextUtils.isEmpty(CombMortgageHAF) ? "0" :CombMortgageHAF);                                 //公积金贷款金额
